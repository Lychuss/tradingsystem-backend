...
import { getProducts, getAllSells, getAllTrades, getAllBooks, getAllNotes, getAllUniforms} from '../repository/itemsRepository.js';
...
export async function getAllUniform(){
    const data = await getAllUniforms();
